...
from .retrieval import RetrievalContractError, _canonical_read, build_retrieval_report_v1, load_retrieval_contract_v1
...
def _verify_retrieval_contract(args: argparse.Namespace) -> int:
    ...
    sys.stdout.buffer.write(canonical_json_bytes(build_retrieval_report_v1(
        target=target, corpus=corpus, config=config, experiment_root=_EXPERIMENT_ROOT,
    )))
    return 0
