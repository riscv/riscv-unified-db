...
Plans:
- [ ] 01-01: Establish the isolated package, artifact layout, dependency boundary, and environment fallback contract.
- [ ] 01-02: Implement the pinned snapshot manifest and consumed-file provenance inventory.
- [ ] 01-03: Verify source hashes, boundary isolation, and the reviewer-facing source-integrity receipt.
...
|-------|----------------|--------|-----------|
| 1. Isolated Evidence Boundary and Source Integrity | 0/3 | Not started | - |
