...
Gem::Specification.new do |s|
  ...
  s.files       = Dir["lib/**/*.rb", "LICENSE", "ext/udb_z3_download/extconf.rb", "lib/udb/Z3_VERSION", "ext/udb_espresso_download/extconf.rb", "lib/udb/ESPRESSO_VERSION", "ext/udb_must_download/extconf.rb", "lib/udb/MUST_VERSION"]
  s.extensions  = ["ext/udb_z3_download/extconf.rb", "ext/udb_espresso_download/extconf.rb", "ext/udb_must_download/extconf.rb"]
