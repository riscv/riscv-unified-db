...
class TestAsciidocUtils < Minitest::Test
  ...
  def test_resolve_links_csr_field
    ...
    assert_equal("<<udb:doc:csr_field:fo_o:ba_r,fo.o.ba.r>>", AsciidocUtils.resolve_links(link_to_udb_doc_csr_field("fo.o","ba.r")))
  end
...
class TestAntoraUtils < Minitest::Test
  ...
  def test_resolve_links_csr_field
    ...
    assert_equal("xref:csrs:fo_o.adoc#udb:doc:csr_field:fo_o:ba_r[fo.o.ba.r]", AntoraUtils.resolve_links(link_to_udb_doc_csr_field("fo.o","ba.r")))
  end
