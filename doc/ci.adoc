...
The tests are defined in xref:tools/test/regress-tests.yaml[`tools/test/regress-tests.yaml`] (jobs with `ci_stage: merge_queue`), run via xref:.github/workflows/regress.yml[`.github/workflows/regress.yml`], and are uploaded via xref:.github/workflows/pages.yml[`.github/workflows/pages.yml`].
