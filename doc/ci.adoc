...
The tests are specified in xref:.github/workflows/regress.yml[`.github/workflows/regress.yml`], and are uploaded via xref:.github/workflows/pages.yml[`.github/workflows/pages.yml`].
