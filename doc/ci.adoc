...
They generate artifacts that are deployed to https://riscv.github.io/riscv-unified-db/[GitHub pages].
...
The tests are defined in xref:tools/test/regress-tests.yaml[`tools/test/regress-tests.yaml`] (jobs with `ci_stage: merge_queue`), and run via xref:.github/workflows/regress.yml[`.github/workflows/regress.yml`].
The resulting artifacts/pages are uploaded via xref:.github/workflows/pages.yml[`.github/workflows/pages.yml`].
