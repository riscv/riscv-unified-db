...
The YAML files follow a [strict data schema](/docs/schemas) defined using [JSON Schema](https://json-schema.org/).
...
See the [Configuration documentation](/docs/concepts/configurations/overview) to learn how to define and use configurations.
...
See the [Data Customization documentation](/docs/concepts/configurations/customization) to learn how overlays work and how data resolution merges standard and custom data.
