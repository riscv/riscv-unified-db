---
title: Exception Code Schema (v0.1)
sidebar_label: Exception Code Schema
custom_edit_url: null
# This file is auto-generated from exception_code_schema.json
...
| `$schema` | `any` | ✓ |  |
| `kind` | `any` | ✓ |  |
| `name` | `string` | ✓ | Name of the exception, as a legal IDL variable name |
| `display_name` | `string` | ✓ | Pretty display version of the name |
| `num` | `integer` | ✓ | Exception number, as reported in the `*cause` CSRs |
