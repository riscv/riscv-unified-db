...
class Writexlsx::Chart
  ...
  include ::Writexlsx::Chart::Initialization
  include ::Writexlsx::Chart::Settings
  include ::Writexlsx::Chart::SeriesData
  include ::Writexlsx::Chart::XmlWriter
  include ::Writexlsx::Chart::AxisWriter
  include ::Writexlsx::Chart::SeriesWriter
  include ::Writexlsx::Chart::FormattingWriter
  ...
  def write_title_rich(title, is_y_axis = T.unsafe(nil)); end
...
class Writexlsx::Chart::Axis
  ...
  def apply_axis_display_options(args); end
  def apply_axis_format_options(args); end
  def apply_axis_options(args); end
  def apply_axis_tick_options(args); end
  def apply_axis_title_options(args); end
  def apply_options(params); end
  def crossing; end
  def defaults; end
...
module Writexlsx::Chart::AxisWriter
...
class Writexlsx::Chart::Caption
  ...
  def apply_format_options(params); end
  def apply_text_options(params); end
  def data_id; end
...
module Writexlsx::Chart::FormattingWriter
  private

  def has_formatting(element); end
  ...
  def write_chart_title(title, is_y_axis = T.unsafe(nil), allow_none: T.unsafe(nil)); end
  def write_custom_label_format(label); end
  ...
  def write_sp_pr(object); end
  def write_symbol(val); end
  def write_title_format_only(title); end
  def write_title_formula(title, is_y_axis = T.unsafe(nil)); end
...
module Writexlsx::Chart::Initialization
  private
...
class Writexlsx::Chart::Series
  ...
  def map_label_position!(property); end
...
module Writexlsx::Chart::SeriesWriter
  private
...
module Writexlsx::Chart::XmlWriter
  ...
  def prepare_combined_chart(second_chart); end
  def write_auto_title_deleted; end
  def write_category_axis_for(params); end
  def write_chart; end
  def write_chart_space(&block); end
  def write_combined_chart_types(second_chart); end
  ...
  def write_plot_area_chart_types(second_chart); end
  def write_plot_area_formatting; end
  def write_plot_area_layout; end
  def write_plot_area_primary_axes; end
  def write_plot_area_secondary_axes(second_chart); end
  def write_primary_and_secondary_chart_types; end
...
class Writexlsx::Chartsheet < ::Writexlsx::Worksheet
  ...
  def add_series(*args, **_arg1, &block); end
  def assemble_xml_file; end
  def chart=(_arg0); end
  def charts; end
  ...
  def set_chartarea(*args, **_arg1, &block); end
  def set_drop_lines(*args, **_arg1, &block); end
  def set_high_low_lines(*args, **_arg1, &block); end
  def set_legend(*args, **_arg1, &block); end
  def set_plotarea(*args, **_arg1, &block); end
  def set_size(*args, **_arg1, &block); end
  def set_style(*args, **_arg1, &block); end
  def set_table(*args, **_arg1, &block); end
  def set_title(*args, **_arg1, &block); end
  def set_up_down_bars(*args, **_arg1, &block); end
  def set_x2_axis(*args, **_arg1, &block); end
  def set_x_axis(*args, **_arg1, &block); end
  def set_y2_axis(*args, **_arg1, &block); end
  def set_y_axis(*args, **_arg1, &block); end
  def show_blanks_as(*args, **_arg1, &block); end
  def show_hidden_data(*args, **_arg1, &block); end
  def show_na_as_empty_cell; end
...
module Writexlsx::Constants; end
Writexlsx::Constants::COL_MAX = T.let(T.unsafe(nil), Integer)
Writexlsx::Constants::ROW_MAX = T.let(T.unsafe(nil), Integer)
Writexlsx::Constants::SHEETNAME_MAX = T.let(T.unsafe(nil), Integer)
Writexlsx::Constants::STR_MAX = T.let(T.unsafe(nil), Integer)
...
class Writexlsx::Format
  ...
  def [](attr); end
  def alignment_style; end
  def bg_color; end
  def bold; end
  def bold=(value); end
  def bold?; end
  def border_attributes; end
  def border_count; end
  def border_count=(value); end
  def border_index; end
  def border_index=(value); end
  def border_style; end
  def bottom; end
  def bottom=(value); end
  def bottom_color; end
  def bottom_color=(value); end
  def color(color_code); end
  def color?; end
  def color_indexed; end
  def color_indexed=(value); end
  def copy(other); end
  def diag_border; end
  def diag_border=(value); end
  def diag_color; end
  def diag_color=(value); end
  def diag_type; end
  def diag_type=(value); end
  def dxf_bg_color; end
  def dxf_bg_color=(value); end
  def dxf_fg_color; end
  def dxf_fg_color=(value); end
  def dxf_index; end
  def dxf_index=(value); end
  def fg_color; end
  def fill_count; end
  def fill_count=(value); end
  def fill_index; end
  def fill_index=(value); end
  def fill_style; end
  def font; end
  def font=(value); end
  def font_charset; end
  def font_charset=(value); end
  def font_color; end
  def font_color=(value); end
  def font_condense; end
  def font_condense=(value); end
  def font_extend; end
  def font_extend=(value); end
  def font_family; end
  def font_family=(value); end
  def font_index; end
  def font_index=(value); end
  def font_outline; end
  def font_outline=(value); end
  def font_scheme; end
  def font_scheme=(value); end
  def font_script; end
  def font_script=(value); end
  def font_shadow; end
  def font_shadow=(value); end
  def font_strikeout; end
  def font_strikeout=(value); end
  def font_style; end
  ...
  def italic?; end
  def just_distrib; end
  def just_distrib=(value); end
  def left; end
  def left=(value); end
  def left_color; end
  def left_color=(value); end
  def locked; end
  def locked=(value); end
  def merge_range; end
  def merge_range=(value); end
  def num_format; end
  def num_format=(value); end
  def num_format_index; end
  def num_format_index=(value); end
  def number_format_style; end
  def outline?; end
  def pattern; end
  def protection_style; end
  def quote_prefix; end
  def quote_prefix=(value); end
  def reading_order; end
  def reading_order=(value); end
  def right; end
  def right=(value); end
  def right_color; end
  def right_color=(value); end
  def rotation; end
  def rotation=(value); end
  def set_align(location); end
  def set_bg_color(value); end
  def set_bold(weight = T.unsafe(nil)); end
  def set_border(value); end
  def set_border_color(value); end
  def set_border_count(value); end
  def set_border_index(value); end
  def set_border_info(borders); end
  def set_bottom(value); end
  def set_bottom_color(value); end
  def set_center_across(_flag = T.unsafe(nil)); end
  def set_color(value); end
  def set_color_indexed(value = T.unsafe(nil)); end
  def set_diag_border(value); end
  def set_diag_color(value); end
  def set_diag_type(value); end
  def set_dxf_index(value); end
  def set_fg_color(value); end
  def set_fill_count(value); end
  def set_fill_index(value); end
  def set_font(value); end
  def set_font_charset(value); end
  def set_font_condense(value); end
  def set_font_extend(value = T.unsafe(nil)); end
  def set_font_family(value); end
  def set_font_info(fonts); end
  def set_font_outline(value = T.unsafe(nil)); end
  def set_font_script(value); end
  def set_font_shadow(value = T.unsafe(nil)); end
  def set_font_strikeout(value = T.unsafe(nil)); end
  def set_format_properties(*properties); end
  def set_has_fill(value); end
  def set_has_font(value = T.unsafe(nil)); end
  def set_hidden(value = T.unsafe(nil)); end
  def set_hyperlink(value); end
  def set_indent(value = T.unsafe(nil)); end
  def set_italic(value = T.unsafe(nil)); end
  def set_left(value); end
  def set_left_color(value); end
  def set_locked(value = T.unsafe(nil)); end
  def set_merge(_merge = T.unsafe(nil)); end
  def set_num_format(format); end
  def set_num_format_index(value); end
  def set_pattern(value); end
  def set_quote_prefix(value = T.unsafe(nil)); end
  def set_right(value); end
  def set_right_color(value); end
  def set_rotation(rotation); end
  def set_shrink(value = T.unsafe(nil)); end
  def set_size(value); end
  def set_text_h_align(value); end
  def set_text_justlast(value = T.unsafe(nil)); end
  def set_text_v_align(value); end
  def set_text_wrap(value = T.unsafe(nil)); end
  def set_theme(value = T.unsafe(nil)); end
  def set_top(value); end
  def set_top_color(value); end
  def set_underline(value = T.unsafe(nil)); end
  def set_valign(location); end
  def set_xf_id(value); end
  def set_xf_index(value); end
  def shadow?; end
  def shrink; end
  def shrink=(value); end
  def size; end
  def size=(value); end
  def state; end
  def strikeout?; end
  def text_h_align; end
  def text_h_align=(value); end
  def text_justlast; end
  def text_justlast=(value); end
  def text_v_align; end
  def text_v_align=(value); end
  def text_wrap; end
  def text_wrap=(value); end
  def theme; end
  def theme=(value); end
  def top; end
  def top=(value); end
  def top_color; end
  def top_color=(value); end
  def underline; end
  def underline=(value); end
  def underline?; end
  ...
  def xf_id=(value); end
  def xf_index; end
  def xf_index=(value); end

  private

  def normalize_format_property_value(value); end
...
class Writexlsx::Format::AlignmentState
  ...
  def just_distrib; end
  def just_distrib=(_arg0); end
  def justlast; end
  def justlast=(_arg0); end
  def merge_range; end
  def merge_range=(_arg0); end
  def reading_order; end
  def reading_order=(_arg0); end
  def rotation; end
  def rotation=(_arg0); end
  def shrink; end
  def shrink=(_arg0); end
  def vertical; end
...
class Writexlsx::Format::AlignmentStyle
  def initialize(format); end

  def horizontal; end
  def horizontal=(value); end
  def indent; end
  def indent=(value); end
  def just_distrib; end
  def just_distrib=(value); end
  def justlast; end
  def justlast=(value); end
  def merge_range; end
  def merge_range=(value); end
  def reading_order; end
  def reading_order=(value); end
...
class Writexlsx::Format::BorderState
  ...
  def bottom_color; end
  def bottom_color=(_arg0); end
  def count; end
  def count=(_arg0); end
  def diag_border; end
  def diag_border=(_arg0); end
  def diag_color; end
  def diag_color=(_arg0); end
  def diag_type; end
  def diag_type=(_arg0); end
  def index; end
  def index=(_arg0); end
  def left; end
  def left=(_arg0); end
  def left_color; end
  def left_color=(_arg0); end
  def right; end
  def right=(_arg0); end
  def right_color; end
  def right_color=(_arg0); end
  def top; end
  def top=(_arg0); end
  def top_color; end
  def top_color=(_arg0); end
...
class Writexlsx::Format::FillStyle
  ...
  def bg_color; end
  def bg_color=(value); end
  def count; end
  def count=(value); end
  def fg_color; end
  def fg_color=(value); end
  def index; end
  def index=(value); end
  def pattern; end
...
class Writexlsx::Format::FontStyle
  ...
  def color_indexed=(value); end
  def condense; end
  def condense=(value); end
  def extend; end
  def extend=(value); end
  def family; end
...
class Writexlsx::Format::FormatState
  ...
  def dxf_index; end
  def dxf_index=(_arg0); end
  def fill; end
  def fill=(_arg0); end
  def font; end
  def font=(_arg0); end
  def has_border; end
  def has_border=(_arg0); end
  def has_dxf_border; end
  def has_dxf_border=(_arg0); end
  def has_dxf_fill; end
  def has_dxf_fill=(_arg0); end
  def has_dxf_font; end
  def has_dxf_font=(_arg0); end
  def has_fill; end
  def has_fill=(_arg0); end
  def has_font; end
  def has_font=(_arg0); end
  ...
  def used_as_dxf; end
  def used_as_dxf=(_arg0); end
  def xf_id; end
  def xf_id=(_arg0); end
  def xf_index; end
  def xf_index=(_arg0); end
...
class Writexlsx::Format::NumberFormatStyle
  def initialize(format); end

  def format_code; end
  def format_code=(value); end
  def index; end
  def index=(value); end
end
...
module Writexlsx::ObjectPositioning
  ...
  def adjust_start_position_for_cell_offsets(col_start, row_start, x1, y1, context); end
  def adjust_start_position_for_negative_offsets(col_start, row_start, x1, y1, context); end
  def calculate_absolute_position(col_start, row_start, x1, y1, context); end
  def calculate_object_end_position(col_start, row_start, x1, y1, width, height, context); end
  def position_object_pixels_with_context(col_start, row_start, x1, y1, width, height, context); end
end
...
class Writexlsx::Shape
  ...
  def init_appearance_attributes; end
  def init_basic_attributes; end
  def init_connection_attributes; end
  def init_position_attributes; end
end
...
module Writexlsx::Utility::ChartFormatting
  def color(color_code); end
  def dash_types; end
...
Writexlsx::Utility::ChartFormatting::PATTERN_TYPES = T.let(T.unsafe(nil), Hash)
...
Writexlsx::Utility::Common::PERL_TRUE_VALUES = T.let(T.unsafe(nil), Array)
...
module Writexlsx::Utility::SheetnameQuoting
  ...
  def already_quoted_sheetname?(name); end
  def contains_non_identifier_chars?(name); end
  def escape_sheetname(name); end
  def sheetname_needs_quoting?(name); end
  def single_rc_reference?(name); end
  def starts_with_digit_or_dot?(name); end
  def starts_with_rc_reference?(name); end
  def valid_a1_reference_name?(name); end
end

module Writexlsx::Utility::StringWidth
  def xl_string_pixel_width(string); end
end

Writexlsx::Utility::StringWidth::CHAR_WIDTHS = T.let(T.unsafe(nil), Hash)
Writexlsx::Utility::StringWidth::DEFAULT_COL_PIXELS = T.let(T.unsafe(nil), Integer)
Writexlsx::Utility::StringWidth::MAX_DIGIT_WIDTH = T.let(T.unsafe(nil), Integer)
Writexlsx::Utility::StringWidth::PADDING = T.let(T.unsafe(nil), Integer)
...
class Writexlsx::Workbook
  ...
  include ::Writexlsx::Utility::CellReference
  include ::Writexlsx::Utility::XmlPrimitives
  include ::Writexlsx::Workbook::Initialization
  include ::Writexlsx::Workbook::PackagePreparation
  include ::Writexlsx::Workbook::FormatPreparation
  include ::Writexlsx::Workbook::ChartData
...
module Writexlsx::Workbook::ChartData
  private
...
module Writexlsx::Workbook::FormatPreparation
  private
...
module Writexlsx::Workbook::Initialization
  ...
  def setup_calculation_state; end
  def setup_core_state(file, options, default_formats); end
  def setup_default_formats; end
  def setup_embedded_assets; end
  def setup_filename; end
  def setup_format_state(_default_formats); end
  def setup_shared_strings; end
  def setup_workbook_state(_options); end
  def tempdir; end
...
module Writexlsx::Workbook::PackagePreparation
  private

  def delete_tempdir(path); end
...
class Writexlsx::Worksheet
  include ::Writexlsx::Constants
  include ::Writexlsx::Worksheet::Initialization
  include ::Writexlsx::Worksheet::CellDataManager
  include ::Writexlsx::Utility::StringWidth
  include ::Writexlsx::Worksheet::RowColSizing
  include ::Writexlsx::Utility::CellReference
  include ::Writexlsx::Utility::ChartFormatting
  include ::Writexlsx::Utility::Dimensions
  include ::Writexlsx::Utility::DateTime
  ...
  include ::Writexlsx::Utility::XmlPrimitives
  include ::Writexlsx::Utility::SheetnameQuoting
  include ::Writexlsx::ObjectPositioning
  include ::Writexlsx::Worksheet::Columns
  include ::Writexlsx::Worksheet::Rows
  include ::Writexlsx::Worksheet::Selection
  include ::Writexlsx::Worksheet::Panes
  include ::Writexlsx::Worksheet::Autofilter
  include ::Writexlsx::Worksheet::ConditionalFormats
  include ::Writexlsx::Worksheet::Formatting
  include ::Writexlsx::Worksheet::Protection
  include ::Writexlsx::Worksheet::PrintOptions
  include ::Writexlsx::Worksheet::CommentsSupport
  include ::Writexlsx::Worksheet::RichTextHelpers
  include ::Writexlsx::Utility::Common
  include ::Writexlsx::Worksheet::DataWriting
  include ::Writexlsx::Worksheet::DrawingMethods
  include ::Writexlsx::Worksheet::DrawingPreparation
  include ::Writexlsx::Worksheet::DrawingRelations
  include ::Writexlsx::Worksheet::DrawingXmlWriter
  include ::Writexlsx::Worksheet::XmlWriter
  extend ::Forwardable
  ...
  def background_image(*args, **_arg1, &block); end
  def charts(*args, **_arg1, &block); end
  def col_info; end
  def comments; end
  ...
  def footer_images(*args, **_arg1, &block); end
  def has_dynamic_functions?; end
  def has_embedded_images?; end
  def has_shapes?; end
  def header_images(*args, **_arg1, &block); end
  def hidden?; end
  ...
  def images(*args, **_arg1, &block); end
  def index; end
  ...
  def set_vba_name(vba_codename = T.unsafe(nil)); end
  def set_xml_writer(filename); end
  def shapes(*args, **_arg1, &block); end
  def show_zeros?; end
...
class Writexlsx::Worksheet::AssetManager
  ...
  def add_chart(chart); end
  def add_footer_image(image); end
  def add_header_image(image); end
  def add_image(image); end
  def add_shape(shape); end
  def add_sparkline(sparkline); end
  def add_table(table); end
  def background_image; end
  def background_image=(_arg0); end
  def charts; end
  def footer_images; end
  def header_images; end
  def images; end
  def reset_footer_images; end
  def reset_header_images; end
  def shapes; end
  def sparklines; end
  def tables; end
end
...
class Writexlsx::Worksheet::CellDataStore
  ...
  def [](row); end
  def each_row; end
  def fetch(row, col); end
  def get_range_data(row_start, col_start, row_end, col_end); end
  def row(row); end
  def row?(row); end
  def store(cell_data, row, col); end
end

module Writexlsx::Worksheet::Columns
  def autofit(max_width = T.unsafe(nil)); end
...
module Writexlsx::Worksheet::DrawingMethods
  ...
  def assign_shape_id(shape); end
  def auto_locate_shape_connectors(shape); end
  def build_inserted_shape(shape); end
  def extract_chart_options(options); end
  def extract_image_options(options); end
  def normalize_row_col_args(row, col, object, options); end
  def normalize_shape_args(row_start, column_start, shape, x_offset, y_offset, x_scale, y_scale, anchor); end
  def set_shape_position(shape, row, col, options); end
end

module Writexlsx::Worksheet::DrawingPreparation
...
module Writexlsx::Worksheet::Initialization
  def apply_excel2003_compatibility; end
  def setup_cell_features; end
  def setup_dependencies; end
  def setup_drawing_and_media; end
  def setup_filter_and_selection_state; end
  def setup_identity(workbook, index, name); end
  def setup_limits; end
  def setup_protection; end
  def setup_row_and_column_state; end
  def setup_sheet_geometry; end
  def setup_view_options; end
  def setup_workbook_dependent_state; end
end
...
module Writexlsx::Worksheet::RichTextHelpers
...
module Writexlsx::Worksheet::RowColSizing
  ...
  def calculate_col_pixels(width, hidden, anchor); end
  def calculate_row_pixels(height, hidden, anchor); end
end

module Writexlsx::Worksheet::Rows
